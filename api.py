...
def help_(DB, args):      
    tell_about_command={
        ...
        'create_jury':'If you want to create a jury called "bitcoin", then type: ./cli.py create_jury bitcoin.',
        ...
        'ask_decision': 'If you wanted to ask the jury <jury>, the question "what will the weather be tomorrow", with the unique identifier "weather_question_203", you would type: ./cli.py ask_decision <jury> maturation_date weather_question_203 what will the weather be tomorrow',
        ...
        'make_PM':'example: ./cli.py make_PM',
        'create_pm':'example: ./cli.py create_pm PM_id B decisions states states_combinatory /n example2: ./cli.py create_pm pm_id_0 1000 decision_0,decision_1 case_1,case_2,case_3,case_4 0,0.1,0.0,1',
        'buy_shares':'example: ./cli.py buy_shares',
        'trade_shares':'example: ./cli.py PM_id -200,1000 #this would sell 200 of the first state in PM_id, and buy 1000 of the second',
